    ...
    <div className="flex flex-col h-full bg-[#0A101D] text-slate-200 border-r border-slate-800/80">
      ...
      <div className="px-2.5 pb-3 border-t border-slate-800/80 pt-2.5 space-y-1">
        ...
        <div className="px-3 py-2 rounded-md bg-slate-900/80 border border-slate-800/60">
          ...
          {user.branch && (
            <p className="text-xs text-slate-300 font-semibold mt-1 flex items-center gap-1.5 truncate">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-bold uppercase tracking-wider text-slate-400 hover:bg-rose-950/30 hover:text-rose-300 transition-colors duration-100"
        >
